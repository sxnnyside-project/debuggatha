/**
 * The shared repository model every analysis stage enriches (Epic 12:
 ...
 * (`@debuggatha/repository-intelligence`, Epic 1) — `rootDir` is the only
 ...
 * `"unknown"` instead of guessing (Epic 12: "do not assume one
 * architectural style").
 */
...
export interface LayerViolation {
  ...
  fromLayer: LayerName;
  toLayer: LayerName;
  /** Every violation explains both sides — Epic 12 "every finding must explain both sides of the violation". */
  explanation: string;
