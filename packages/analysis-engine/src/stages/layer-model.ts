 ...
 * forced into a guessed layer (Epic 12: "do not assume one architectural
 * style").
 */
...
/** Layer Model (Epic 12): assigns each Module Boundary a conventional layer name, purely from its id/name — never from its dependencies (that would be circular with Layer Violations, which consumes this). */
