...
**GitHub Issues**
For bugs or unexpected behavior, open an [issue](https://github.com/sxnnyside-project/debuggatha/issues). Use the bug report template and include enough context to reproduce the problem.
